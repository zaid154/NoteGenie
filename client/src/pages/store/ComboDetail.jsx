...
import { IconArrowLeft, IconCart, IconCheck } from "../../components/icons.jsx";
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <div className="panel space-y-4 p-6 shadow-soft">
        {combo.coverUrl && <img src={combo.coverUrl} alt="" className="h-48 w-full rounded-xl object-cover" />}
        <h1 className="text-2xl font-bold text-ink">{combo.title}</h1>
